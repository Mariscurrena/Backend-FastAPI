...
users_list = [User(name="Angel", surname="Mariscurrena", url="https://mariscurrena.github.io/Portfolio-AM/", age=24),
              User(name="Andrea", surname="Trujillo", url="https://mariscurrena.github.io/Portfolio-AM/", age=24),
              User(name="Emilio", surname="Mariscurrena", url="https://mariscurrena.github.io/Portfolio-AM/", age=12)] ### Creates instances of User class
